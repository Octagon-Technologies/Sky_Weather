package com.octagontechnologies.sky_weather.core.model.preferences
...
enum class WindDirectionUnits {
    CARDINAL,
    DEGREES,
    ;

    companion object {
        fun getDefault() = CARDINAL
    }
}
...
fun TimeFormat?.getAmOrPmBasedOnTime(
    hourIn24HourSystem: Int,
    date: Date,
): String =
