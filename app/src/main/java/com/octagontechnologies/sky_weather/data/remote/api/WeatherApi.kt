package com.octagontechnologies.sky_weather.data.remote.api

import com.octagontechnologies.sky_weather.data.remote.api.weather.current.CurrentForecastResponse
import com.octagontechnologies.sky_weather.data.remote.api.weather.daily.DailyForecastResponse
import com.octagontechnologies.sky_weather.data.remote.api.weather.hourly.HourlyForecastResponse
...
const val CURRENT_WEATHER_FIELDS =
    "is_day,temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature," +
        "precipitation_probability,precipitation,snow_depth,weather_code,pressure_msl," +
        "surface_pressure,cloud_cover,visibility,evapotranspiration,wind_speed_10m," +
        "wind_speed_80m,wind_direction_10m,wind_gusts_10m,soil_temperature_0cm," +
        "soil_moisture_0_to_1cm,uv_index,terrestrial_radiation"
const val HOURLY_WEATHER_FIELDS =
    "temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature," +
        "precipitation_probability,precipitation,snow_depth,weather_code," +
        ...
        "soil_moisture_0_to_1cm,uv_index,terrestrial_radiation,is_day"
const val DAILY_WEATHER_FIELDS =
    "weather_code,temperature_2m_max,temperature_2m_min,apparent_temperature_max," +
        ...
        "precipitation_probability_min,wind_speed_10m_max,wind_speed_10m_min," +
        "wind_gusts_10m_max,wind_gusts_10m_min,relative_humidity_2m_max," +
        "relative_humidity_2m_min,pressure_msl_min,surface_pressure_min," +
        "cloud_cover_min,pressure_msl_max,surface_pressure_max,cloud_cover_max"
...
//        @Query("timeformat") timeFormat: String = WEATHER_TIME_FORMAT,
        @Query("timezone") timeZone: String = "auto",
        @Query("start_hour") startHour: String = Instant.now().toDateTime().toString("yyyy-MM-dd'T'HH:mm"),
        // ("yyyy-mm-ddThh:mm")
