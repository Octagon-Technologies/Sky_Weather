...
import com.octagontechnologies.sky_weather.data.local.room.toLocalLocation
...
class LocationRepo
    ...
    constructor(
        ...
        suspend fun updateCurrentLocationInDatabase(latLng: LatLng) =
            doOperation {
        ...
        private suspend fun getLocationNameFromCoordinates(
            ...
            val location =
                locationApi
                    .getLocationFromCoordinates(lat = lat, lon = lon)
                    .toLocation()
            currentLocationDao.insertData(CurrentLocation(currentLocation = location))
