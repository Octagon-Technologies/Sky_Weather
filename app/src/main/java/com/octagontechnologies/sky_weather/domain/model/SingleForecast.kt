package com.octagontechnologies.sky_weather.domain.model
...
fun SingleForecast?.getFormattedFeelsLike(units: Units?): String = "FeelsLike " + getBasicFeelsLike(units)
...
fun SingleForecast?.getFormattedTerrestrialRad(): String = (this?.terrestrialRadiation?.toInt()?.toString() ?: "--") + " W/m²"

fun SingleForecast?.getFormattedSnowDepth(): String = (this?.snowDepth?.toInt()?.toString() ?: "--") + " m"

fun SingleForecast?.getFormattedSoilMoisture(): String = (this?.soilMoisture?.toInt()?.toString() ?: "--") + " m³/m³"
