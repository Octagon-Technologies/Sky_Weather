package com.octagontechnologies.sky_weather.core.notifications
...
import com.octagontechnologies.sky_weather.MainActivity
...
class CustomNotificationCompat
    @Inject
    constructor(
        ...
        fun createNotification(
            ...
            Timber.Forest.d("createNotification called: Part 1")
            ...
            Timber.Forest.d("createNotification called: PArt 2")
            ...
            val notification =
                NotificationCompat
                    ...
                    .apply {
                        ...
                        setContentText(singleForecast.getFormattedTemp(units) + (units ?: Units.Companion.getDefault()).getUnitSymbol())

                        setCustomHeadsUpContentView(null)
                        setContentIntent(clickPendingIntent)
                    }.build()

            Timber.Forest.d("createNotification called with notification as $notification")
            notificationManagerCompat.cancelAll()
