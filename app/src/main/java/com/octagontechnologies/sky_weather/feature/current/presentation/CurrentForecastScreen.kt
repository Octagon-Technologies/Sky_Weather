...
import com.octagontechnologies.sky_weather.core.designsystem.theme.CabinCondensed
import com.octagontechnologies.sky_weather.core.designsystem.theme.LessDarkBlue
import com.octagontechnologies.sky_weather.core.designsystem.theme.LightBlack
import com.octagontechnologies.sky_weather.core.designsystem.theme.LocalAppColors
import com.octagontechnologies.sky_weather.core.designsystem.theme.Poppins
...
import com.octagontechnologies.sky_weather.core.ui.system.getActivity
import com.octagontechnologies.sky_weather.domain.model.SingleForecast
import com.octagontechnologies.sky_weather.domain.model.getFormattedFeelsLike
...
import com.octagontechnologies.sky_weather.feature.current.presentation.components.CurrentTopBar
import com.octagontechnologies.sky_weather.feature.current.presentation.components.ShimmerCurrentForecastScreen
import com.octagontechnologies.sky_weather.feature.current.presentation.formatter.getCoreWeatherConditions
import com.octagontechnologies.sky_weather.feature.forecast.presentation.selected_details.LunarPreview
        ...
        border =
            BorderStroke(
                ...
                if (theme == Theme.BLACK) {
                    ...
                    Brush.linearGradient(0f to LessDarkBlue, 1f to LessDarkBlue)
                },
            ),
    ) {
        Box(
...
@Preview
@Composable
private fun PreviewCurrentForecastScreen() =
    AppTheme {
